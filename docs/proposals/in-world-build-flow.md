...
- **Which way does the exterior face?** The player might build from inside the house or outside. Now I'm guessing the natural default is "exterior faces away from the player", with a sneak or tool-mode flip. Settle in the first playtest.
