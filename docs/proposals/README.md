...
- [`sealed-wall-glow`](sealed-wall-glow.md) — a sealed siding room reads dark but glows at the corners and roof line; split stale meshes from smooth lighting, then fix.
