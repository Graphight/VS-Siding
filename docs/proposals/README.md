...
- [`window-frames`](window-frames.md) — a glass infill that seals without going opaque, then a `window` frame mode whose openings merge into one in both directions; doors need nothing (vanilla seals them).
