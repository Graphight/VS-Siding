...
- With both fixes, a stone-infilled cellar is sealed, dark and small, but gets only about half the spoilage bonus of an identical rammed-earth one. Clay infill behaves the same, since the cause is in the walls, not the infill. See `siding-cellar-strength`.
